...
public class DGame {
    ...
    public static String moveDescription(String name) {
        ...
        if(name.equalsIgnoreCase("mob 100") || name.equalsIgnoreCase("mob100") || name.equalsIgnoreCase("mob 100%")) return "**Lose control of your emotions and increase your strength!**\n(`6-10 HP` strength boost)\n> `Type`: Ultimate\n> `Blockable`: False";
